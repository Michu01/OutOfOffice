        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Absence reason 10", null, 90, new DateOnly(2020, 12, 18), new DateOnly(2020, 12, 3), 1 },
                    ...
                    { 29, "Absence reason 4", "Comment", 89, new DateOnly(2020, 10, 5), new DateOnly(2020, 9, 11), 1 },
                    ...
                    { 33, "Absence reason 5", "Comment", 70, new DateOnly(2020, 10, 22), new DateOnly(2020, 9, 30), 1 },
                    { 34, "Absence reason 3", null, 76, new DateOnly(2023, 9, 28), new DateOnly(2023, 9, 3), 0 },
                    { 35, "Absence reason 3", null, 59, new DateOnly(2021, 4, 4), new DateOnly(2021, 3, 14), 1 },
                    { 36, "Absence reason 9", null, 26, new DateOnly(2021, 1, 6), new DateOnly(2020, 12, 25), 0 },
                    { 37, "Absence reason 1", null, 84, new DateOnly(2021, 12, 18), new DateOnly(2021, 11, 26), 1 },
                    ...
                    { 43, "Absence reason 4", "Comment", 59, new DateOnly(2022, 5, 22), new DateOnly(2022, 4, 28), 1 },
                    ...
                    { 49, "Absence reason 7", null, 114, new DateOnly(2023, 10, 8), new DateOnly(2023, 9, 15), 1 },
                    { 50, "Absence reason 1", "Comment", 110, new DateOnly(2020, 5, 12), new DateOnly(2020, 4, 12), 1 },
                    ...
                    { 54, "Absence reason 5", "Comment", 111, new DateOnly(2022, 10, 31), new DateOnly(2022, 10, 26), 1 },
                    ...
                    { 57, "Absence reason 7", "Comment", 69, new DateOnly(2023, 4, 27), new DateOnly(2023, 3, 29), 1 },
                    ...
                    { 76, "Absence reason 2", "Comment", 63, new DateOnly(2021, 6, 23), new DateOnly(2021, 6, 21), 1 },
                    ...
                    { 81, "Absence reason 6", null, 38, new DateOnly(2023, 6, 6), new DateOnly(2023, 6, 3), 1 },
                    ...
                    { 95, "Absence reason 2", null, 94, new DateOnly(2020, 11, 29), new DateOnly(2020, 11, 28), 1 },
                    ...
                    { 104, "Absence reason 3", "Comment", 95, new DateOnly(2022, 7, 28), new DateOnly(2022, 6, 28), 1 },
                    { 105, "Absence reason 5", null, 42, new DateOnly(2021, 9, 24), new DateOnly(2021, 9, 1), 0 },
                    { 106, "Absence reason 1", null, 39, new DateOnly(2023, 7, 9), new DateOnly(2023, 6, 15), 1 },
                    ...
                    { 135, "Absence reason 4", null, 38, new DateOnly(2022, 9, 6), new DateOnly(2022, 8, 8), 1 },
                    ...
                    { 141, "Absence reason 2", "Comment", 110, new DateOnly(2023, 2, 6), new DateOnly(2023, 1, 28), 1 },
                    ...
                    { 145, "Absence reason 2", "Comment", 42, new DateOnly(2022, 2, 16), new DateOnly(2022, 1, 26), 1 },
                    ...
                    { 153, "Absence reason 8", null, 70, new DateOnly(2020, 6, 22), new DateOnly(2020, 5, 28), 1 },
                    ...
                    { 159, "Absence reason 4", null, 100, new DateOnly(2023, 3, 30), new DateOnly(2023, 3, 23), 1 },
                    ...
                    { 171, "Absence reason 7", null, 59, new DateOnly(2023, 9, 25), new DateOnly(2023, 8, 28), 1 },
                    ...
                    { 188, "Absence reason 1", "Comment", 90, new DateOnly(2023, 6, 6), new DateOnly(2023, 5, 8), 1 },
                    ...
                    { 194, "Absence reason 6", null, 83, new DateOnly(2021, 3, 19), new DateOnly(2021, 3, 11), 1 },
                    ...
                    { 197, "Absence reason 1", null, 105, new DateOnly(2022, 3, 25), new DateOnly(2022, 3, 7), 1 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 256, 12, null, 102, 1 },
                    { 257, 3, null, 102, 0 },
                    { 258, 17, "Comment", 103, 1 },
                    { 259, 20, null, 103, 2 },
                    { 260, 20, "Comment", 103, 1 },
                    { 261, 6, null, 103, 2 },
                    { 262, 9, "Comment", 104, 1 },
                    { 263, 3, null, 105, 0 },
                    { 264, 18, "Comment", 106, 1 },
                    { 265, 10, null, 106, 1 },
                    { 266, 18, null, 107, 0 },
                    { 267, 16, null, 107, 1 },
                    ...
                    { 275, 11, "Comment", 110, 1 },
                    { 276, 19, "Comment", 111, 1 },
                    { 277, 13, null, 111, 1 },
                    { 278, 4, null, 111, 0 },
                    { 279, 19, null, 112, 2 },
                    { 280, 4, null, 112, 0 },
                    { 281, 18, null, 113, 2 },
                    { 282, 10, "Comment", 113, 1 },
                    ...
                    { 295, 17, "Comment", 117, 1 },
                    { 296, 19, "Comment", 117, 1 },
                    { 297, 21, null, 117, 2 },
                    { 298, 4, null, 117, 1 },
                    ...
                    { 301, 12, null, 118, 2 },
                    { 302, 20, null, 118, 2 },
                    { 303, 18, "Comment", 118, 1 },
                    { 304, 6, "Comment", 118, 1 },
                    { 305, 21, null, 119, 2 },
                    { 306, 13, "Comment", 119, 1 },
                    { 307, 10, null, 119, 0 },
                    ...
                    { 483, 10, "Comment", 193, 1 },
                    { 484, 13, "Comment", 194, 1 },
                    { 485, 4, "Comment", 194, 1 },
                    { 486, 2, null, 195, 0 },
